...
write_key = os.environ.get('WRITE_KEY') or os.environ.get('write_key')    # GitHub action needs to set env variable. You need to create a GitHub secret called WRITE_KEY
